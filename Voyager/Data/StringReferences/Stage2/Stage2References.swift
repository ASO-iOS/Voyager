...
struct Stage2DiceReference: PhraseDelegate {
    ...
    private let textSide0 = PhraseData(
        text: "Как оказывается, у тебя неплохие руки. Не как у стоматолога или микрохирурга, но, тем не менее. Ты это заметил, когда удалось почувствовать, что один из игральных кубиков тяжелее другого. С этим точно нужно было делать что-то, так как соперник очевидно жульничал. Вопрос в том, что именно.",
        type: .common
    )
    ...
    private let textSide1 = PhraseData(
        text: "Как поступить?",
        type: .common,
        answerPositive: "Шантажировать",
        answerNegative: "Сдать ментам",
        answerNeutral: "Рассказать всем на районе",
        hasAnswers: true
    )
    
    private let textSideNegative = PhraseData(
        text: "Ты решил поступить как ответственный гражданин – вызвал полицию. Приехавших заинтересовало то, чем вы тут занимаетесь, вот только сильно разбираться они не стали – повязали всех одинаково. Тебе дали шанс откупиться, чтобы не посещать отдел – пришлось выдать всё, что тогда было при тебе. Ты, так сказать, заплатил штраф майору. Или дал взятку с его подачи. Но за взятку ещё пока не успели напрячь, так что это стоило, наверное, считать штрафом.",
        type: .common
    )
    
    private let textSideNeutral = PhraseData(
        text: "Так как состояние здоровья твоё было шатким, не хотелось ввязываться в драку на таких условиях, да ещё к тому же без умений в ней побеждать. Ты решил поступить иначе, при возможности сообщая всем знакомым игрокам, что тот парень мухлюет. Уже очень скоро сарафанное радио своё дело сделало, с ним играть перестали, причём ты в том числе – он уже не выказывал готовности покидать кости. Возможно, обиделся.",
        type: .common
    )
    
    private let textSidePositive0 = PhraseData(
        text: "- Эй, братишка, я тут примерно прочувствовал, у тебя кости разные по массе, это вряд ли понравится остальным игрокам – все решат мгновенно, что ты жульничаешь.",
        type: .mc
    )
    
    private let textSidePositive1 = PhraseData(
        text: "- Воу, воу, бро! Полегче! Что за голословные обвинения? Как ты так мог понять, взвесил мизинцем что ли? Ладно, предлагаю сделку. С тобой я буду играть всегда честно, а за молчание доплачу сейчас сразу. Соглашайся, пока я добрый.",
        type: .thimblesMan
    )
    
    
    var phrases: [PhraseData] {
        return [text0, text1, text2, text3, text4, text5, textSide0, textSide1, textSideNegative, textSideNeutral, textSidePositive0, textSidePositive1]
    }
}
